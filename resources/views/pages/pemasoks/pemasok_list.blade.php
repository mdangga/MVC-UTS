    ...
    @if ($pemasoks->count())
        ...
        <div
            ...
            <div class="p-4 text-center">
                ...
                <h3 class="text-lg font-bold mb-2 text-terracotta">Tambah Pemasok Baru</h3>
                <p class="text-sm opacity-80 mb-4 text-terracotta">Tambahkan pemasok ke inventaris</p>
        ...
        @foreach ($pemasoks as $pemasok)
            <div class="item card-hover glass-effect rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="p-3 text-center bg-warm-beige">
                    ...
                    <button onclick="confirmDelete({{ $pemasok->id_pemasok }})"
        ...
        <div class="col-span-full">
            <div class="glass-effect rounded-2xl shadow-lg p-8 text-center">
                ...
                <p class="text-lg opacity-80 mb-6 text-terracotta">
                    Belum ada pemasok yang ditambahkan.
                </p>
                <a href="{{ route('pemasok.create') }}"
...
<!-- Pagination -->
<div class="mt-6">
    {!! $pemasoks->appends(request()->except('page'))->links() !!}
</div>
...
<div id="deleteModal"
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm text-center">
        <h2 class="text-lg font-semibold mb-4 text-terracotta">Hapus Pemasok</h2>
        <p class="text-sm text-gray-600 mb-6">Apakah kamu yakin ingin menghapus pemasok ini? Tindakan ini tidak bisa
            dibatalkan.</p>
...
<script>
    function confirmDelete(id) {
        // Set action ke route Laravel yang sesuai: /pemasok/{id}/destroy
        const form = document.getElementById('deleteForm');
        form.action = `/pemasok/${id}/destroy`;
